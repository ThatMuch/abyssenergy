...
$block_id = 'project-showcase-' . (isset($block['id']) ? $block['id'] : uniqid());
...
<?php else : ?>
	...
	<section <?php echo $anchor; ?>class="<?php echo esc_attr($class_name); ?> section" data-block-id="<?php echo esc_attr($block_id); ?>">
		<div class="container">
			<?php if ($show_title) : ?>
